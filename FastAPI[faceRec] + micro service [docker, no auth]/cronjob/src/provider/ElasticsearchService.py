...
class ElasticsearchService:
    ...
    def delete_index(self, username):
        try:
            ...
            logger.error('[delete_index]: {}'.format(e))
    ...
    #     except Exception as e:
    #         logging.error('[face_register] regist face to es: {}'.format(e))
    ...
    #     except Exception as e:
    #         logging.error('[delete_staff] regist face to es: {}'.format(e))
    ...
    #     except Exception as e:
    #         logging.error('[search_staff]: {}'.format(e))
